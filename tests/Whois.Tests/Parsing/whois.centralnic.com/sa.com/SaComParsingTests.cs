...
public class SaComParsingTests : ParsingTests
{
    ...
    {
        var sample = SampleReader.Read("whois.centralnic.com", "sa.com", "not-found", "not_found.txt");
    ...
    {
        var sample = SampleReader.Read("whois.centralnic.com", "sa.com", "found", "found.txt");
        var response = parser.Parse("whois.centralnic.com", sample);
