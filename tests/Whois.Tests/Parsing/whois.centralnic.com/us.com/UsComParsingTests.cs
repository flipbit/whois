...
public class UsComParsingTests : ParsingTests
{
    ...
    {
        var sample = SampleReader.Read("whois.centralnic.com", "us.com", "not-found", "not_found.txt");
    ...
    {
        var sample = SampleReader.Read("whois.centralnic.com", "us.com", "found", "found.txt");
        var response = parser.Parse("whois.centralnic.com", sample);
