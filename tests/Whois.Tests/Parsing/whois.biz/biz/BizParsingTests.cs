...
namespace Whois.Parsing.Whois.Biz.Biz
{
    public class BizParsingTests : ParsingTests
    {
        ...
        public void Test_found()
        {
            ...
            Assert.Equal(new DateTime(2017, 02, 22, 10, 27, 42, 000, DateTimeKind.Utc), response.Updated);
            Assert.Equal(new DateTime(2002, 03, 27, 16, 03, 44, 000, DateTimeKind.Utc), response.Registered);
            Assert.Equal(new DateTime(2018, 03, 26, 23, 59, 59, 000, DateTimeKind.Utc), response.Expiration);

             // Registrant Details
            Assert.Equal("C42709140-BIZ", response.Registrant.RegistryId);
            ...
            Assert.Equal("C42709140-BIZ", response.AdminContact.RegistryId);
            ...
            Assert.Equal("C42709140-BIZ", response.TechnicalContact.RegistryId);
