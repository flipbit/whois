...
public class NetParsingTests : ParsingTests
{
    ...
    public void Test_found()
    {
        ...
        Assert.Equal(new DateTime(2017, 02, 11, 10, 56, 38, 000, DateTimeKind.Utc), response.Updated);
        Assert.Equal(new DateTime(1999, 03, 15, 08, 00, 00, 000, DateTimeKind.Utc), response.Registered);
        Assert.Equal(new DateTime(2018, 03, 14, 07, 00, 00, 000, DateTimeKind.Utc), response.Expiration);
