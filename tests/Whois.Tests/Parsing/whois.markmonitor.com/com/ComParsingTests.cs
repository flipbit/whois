...
public class ComParsingTests : ParsingTests
{
    ...
    public void Test_found()
    {
        ...
        Assert.Equal(new DateTime(2015, 06, 12, 17, 38, 52, 000, DateTimeKind.Utc), response.Updated);
        Assert.Equal(new DateTime(1997, 09, 15, 07, 00, 00, 000, DateTimeKind.Utc), response.Registered);
        Assert.Equal(new DateTime(2020, 09, 14, 04, 00, 00, 000, DateTimeKind.Utc), response.Expiration);
        ...
        Assert.Equal("Please contact contact-admin@google.com, 1600 Amphitheatre Parkway", response.Registrant.Address[0]);
