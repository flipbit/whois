...
namespace Whois.Parsing.Whois.Nic.Xyz.Xyz
{
    ...
    public class XyzParsingTests : ParsingTests
    {
        ...
        public void Test_found()
        {
            ...
            Assert.AreEqual("abc.xyz", response.DomainName.ToString());
            Assert.AreEqual("D2192285-CNIC", response.RegistryDomainId);
            ...
            Assert.AreEqual(new DateTime(2025, 03, 20, 23, 59, 59, 000, DateTimeKind.Utc), response.Expiration);
