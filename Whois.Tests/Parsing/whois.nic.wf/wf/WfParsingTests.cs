...
namespace Whois.Parsing.Whois.Nic.Wf.Wf
{
    ...
    public class WfParsingTests : ParsingTests
    {
        ...
        public void Test_found()
        {
            ...
            Assert.AreEqual("nic.wf", response.DomainName.ToString());
            ...
            Assert.AreEqual(new DateTime(2017, 12, 31, 00, 00, 00, 000, DateTimeKind.Utc), response.Expiration);
             ...
             // Registrant Details
            Assert.AreEqual("AEFT2-FRNIC", response.Registrant.RegistryId);
            Assert.AreEqual("Afnic (Wallis et Futuna - TOM)", response.Registrant.Name);
