...
namespace Whois.Parsing.Whois.Nic.Nf.Nf
{
    ...
    public class NfParsingTests : ParsingTests
    {
        ...
        public void Test_not_found()
        {
            ...
            Assert.AreEqual("u34jedzcq.nf", response.DomainName);
        ...
        public void Test_found()
        {
            ...
            Assert.AreEqual("google.nf", response.DomainName);
            ...
            Assert.AreEqual("whois.nic.nf", response.Registrar.WhoisServerUrl);
