...
namespace Whois.Parsing.Whois.Nic.Hn.Hn
{
    ...
    public class HnParsingTests : ParsingTests
    {
        ...
        public void Test_not_found()
        {
            ...
            var response = parser.Parse("whois.nic.hn", "hn", sample);
            ...
            Assert.AreEqual("u34jedzcq.hn", response.DomainName);
        ...
        public void Test_found()
        {
            ...
            Assert.AreEqual("google.hn", response.DomainName);
            ...
            Assert.AreEqual("whois.nic.hn", response.Registrar.WhoisServerUrl);
