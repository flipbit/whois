...
namespace Whois.Parsing.Whois.Sx.Sx
{
    ...
    public class SxParsingTests : ParsingTests
    {
        ...
        public void Test_found()
        {
            ...
            Assert.AreEqual("2, rue L�on Laval", response.Registrant.Address[0]);
            ...
            Assert.AreEqual("2, rue L�on Laval", response.AdminContact.Address[0]);
            ...
            Assert.AreEqual("2, rue L�on Laval", response.TechnicalContact.Address[0]);
