...
namespace Whois.Parsing.Whois.Nic.Fr.Tf
{
    ...
    public class TfParsingTests : ParsingTests
    {
        ...
        public void Test_other_status_frozen()
        {
            ...
            Assert.AreEqual(new DateTime(2004, 10, 29, 00, 00, 00, 000, DateTimeKind.Utc), response.Updated);
            Assert.AreEqual(new DateTime(2004, 10, 26, 00, 00, 00, 000, DateTimeKind.Utc), response.Registered);

             // Registrant Details
            Assert.AreEqual("AAEA9-FRNIC", response.Registrant.RegistryId);
            Assert.AreEqual("Afnic (Terres Australes et Antarctiques - TOM)", response.Registrant.Name);
            ...
            Assert.AreEqual("FROZEN", response.DomainStatus[0]);
        ...
        public void Test_found()
        {
            ...
            Assert.AreEqual(new DateTime(2016, 10, 25, 00, 00, 00, 000, DateTimeKind.Utc), response.Updated);
            Assert.AreEqual(new DateTime(2004, 10, 26, 00, 00, 00, 000, DateTimeKind.Utc), response.Registered);
            Assert.AreEqual(new DateTime(2017, 10, 25, 00, 00, 00, 000, DateTimeKind.Utc), response.Expiration);
