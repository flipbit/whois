...
namespace Whois.Parsing.Whois.Nic.Tl.Tl
{
    ...
    public class TlParsingTests : ParsingTests
    {
        ...
        public void Test_not_found()
        {
            ...
            var response = parser.Parse("whois.nic.tl", "tl", sample);
            ...
            Assert.AreEqual("u34jedzcq.tl", response.DomainName);
        ...
        public void Test_found()
        {
            ...
            Assert.AreEqual("google.tl", response.DomainName);
            ...
            Assert.AreEqual("whois.nic.tl", response.Registrar.WhoisServerUrl);
