...
namespace Whois.Parsing.Whois.Denic.De.De
{
    ...
    public class DeParsingTests : ParsingTests
    {
        ...
        public void Test_failed()
        {
            ...
            Assert.AreEqual("Bor�s", response.AdminContact.Address[2]);
            ...
            Assert.AreEqual("Bor�s", response.TechnicalContact.Address[2]);
        ...
        public void Test_failed_status_failed_ace()
        {
            ...
            Assert.AreEqual("t�stdomain-failed-nserver.de", response.DomainName.ToUnicodeString());
