...
namespace Whois.Parsing.Whois.Za.Org.ZaOrg
{
    ...
    public class ZaOrgParsingTests : ParsingTests
    {
        ...
        public void Test_not_found()
        {
            ...
            var response = parser.Parse("whois.za.org", "za.org", sample);
            ...
            Assert.AreEqual("u34jedzcq.za.org", response.DomainName);
        ...
        public void Test_found()
        {
            ...
            Assert.AreEqual("csa.za.org", response.DomainName);
